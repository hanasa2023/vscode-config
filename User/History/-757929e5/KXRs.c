...
void Ledscan()
{
	...
	P0=0xFF;//���������
   	switch(i)
	{
		case 0:ADDR2=0;ADDR1=0;ADDR0=0;P0=LedBuf[0];i++;break;		
		case 1:ADDR2=0;ADDR1=0;ADDR0=1;P0=LedBuf[1];i++;break;		
		case 2:ADDR2=0;ADDR1=1;ADDR0=0;P0=LedBuf[2];i++;break;		
		case 3:ADDR2=0;ADDR1=1;ADDR0=1;P0=LedBuf[3];i++;break;		
		case 4:ADDR2=1;ADDR1=0;ADDR0=0;P0=LedBuf[4];i++;break;		
		case 5:ADDR2=1;ADDR1=0;ADDR0=1;P0=LedBuf[5];i=0;break;		
	}
}
void Keyscan() //���ڽ�ɳ̲�̳�//
{
